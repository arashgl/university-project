...
import { useFollowCam } from "./hooks/useFollowCam.tsx";
...
export { useGame } from "./stores/useGame.ts";
export { EcctrlJoystick } from "./EcctrlJoystick.tsx";
export { useJoystickControls } from "./stores/useJoystickControls.ts";
...
const Ecctrl: ForwardRefRenderFunction<RapierRigidBody, EcctrlProps> = (
  ...
  const moveCharacter = (
    ...
    if (
      typeof actualSlopeAngle == "number" &&
